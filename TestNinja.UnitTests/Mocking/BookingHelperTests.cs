...
namespace TestNinja.UnitTests.Mocking
{
    ...
    public class BookingHelper_OverlappingBookingsExistTests
    {
        ...
        [Test]
        public void BookingStartsAndFinishesDuringExistingBooking_ReturnExistingBookingsReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingStartsDuringAndFinishesAfterExistingBooking_ReturnExistingBookingsReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
